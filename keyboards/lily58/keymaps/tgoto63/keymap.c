...
#define X_ALTBS LALT_T(KC_BSPC)  // Tap: Bspc, Hold: Alt
#define XX_LCTRL LCTL_T(KC_ESC)
...
[_QWERTY] = LAYOUT( \
  ...
  XX_LCTRL,  KC_A,   KC_S,   KC_D,    KC_F,    KC_G,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,   KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV, \
                            X_ALTBS, X_LOW,   KC_LGUI, KC_SPC,  KC_ENT,   X_RAIBS, X_RAI,   XXXXXXX \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  _______, XXXXXXX, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, SS,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, C(KC_1), C(KC_LEFT), C(KC_RIGHT), XXXXXXX, XXXXXXX, \
                             _______, _______, _______, _______, _______, _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
